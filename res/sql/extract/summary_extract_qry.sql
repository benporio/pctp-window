SELECT 
--COLUMNS
    Code, U_BookingNumber, U_BookingDate, U_ClientName, U_SAPClient, U_ClientVatStatus, U_TruckerName, U_SAPTrucker, U_TruckerVatStatus, U_VehicleTypeCap, U_ISLAND, U_ISLAND_D, U_IFINTERISLAND, U_DeliveryStatus,
    ...
    U_PaymentStatus, U_ProofOfPayment, U_TotalRecClients, U_TotalPayable, U_PVNo, U_TotalAR, U_VarAR, U_TotalAP, U_VarTP, U_APDocNum, U_ARDocNum, U_DeliveryOrigin, U_Destination, U_PODStatusDetail, U_ServiceType,
    U_InvoiceNo
--COLUMNS
